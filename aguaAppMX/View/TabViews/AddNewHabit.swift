...
struct AddNewHabit: View {
    ...
    var body: some View {
        NavigationView{
            VStack(spacing: 15){
                TextField("Hábito", text: $habitModel.title)
                    .padding(.horizontal)
                    .padding(.vertical,10)
                ...
                HStack(spacing: 12){
                    ...
                    TextField("Texto de recordatorio", text: $habitModel.remainderText)
                        .padding(.horizontal)
                        .padding(.vertical,10)
                        .background(Color("TFBG").opacity(0.4),in: RoundedRectangle(cornerRadius: 6, style: .continuous))
                }
            ...
            .navigationTitle(habitModel.editHabit != nil ? "Editar Hábito" : "Agregar Hábito")
            .toolbar {
